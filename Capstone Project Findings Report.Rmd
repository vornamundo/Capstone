---
title: "Capstone Project Findings Report"
author: "Anna Vaughan"
...
```{r process_all, echo = FALSE, cache = T}
source("R Script for Capstone - Data Import.R")
source("R Script for Capstone - Data Cleaning.R")
source("R Script for Capstone - Data Wrangling.R")
source("R Script for Capstone - Exploratory Data Analysis.R")
```

## Capstone Project Findings Report
...
```{r results = 'asis'}
library(knitr)
kable(MMU_Salf_App_Numbers_6, caption = "Applications by higher education institution")
```
...
```{r applications_by_year_by_inst}
...
library(knitr)
library(kableExtra)
kable(cbind(Subject_Group_2016_MMU_UoS_Percentage_Only_Spread_Totals), caption = "Percentage of institution's total applications that are for each subject group, by higher education institution", format = "latex", booktabs = T) %>%
